...
const DropdownNotification = () => {
    ...
    return (<ClickOutside_1.default onClick={() => setDropdownOpen(false)} className="relative hidden sm:block">
      <li>
        ...
        {dropdownOpen && (<div className={`absolute -right-27 mt-7.5 flex h-[550px] w-75 flex-col rounded-xl border-[0.5px] border-stroke bg-white px-5.5 pb-5.5 pt-5 shadow-default dark:border-dark-3 dark:bg-gray-dark sm:right-0 sm:w-[364px]`}>
            ...
            <ul className="no-scrollbar mb-5 flex h-auto flex-col gap-1 overflow-y-auto">
              {notificationList.map((item, index) => (<li key={index}>
                  <link_1.default className="flex items-center gap-4 rounded-[10px] p-2.5 hover:bg-gray-2 dark:hover:bg-dark-3" href="#">
                    <span className="block h-14 w-14 rounded-full">
                      <image_1.default width={112} height={112} src={item.image} style={{
                    width: "auto",
                    height: "auto",
                }} alt="User"/>
                    </span>
            ...
            <link_1.default className="flex items-center justify-center rounded-[7px] border border-primary p-2.5 font-medium text-primary hover:bg-blue-light-5 dark:border-dark-4 dark:text-dark-6 dark:hover:border-primary dark:hover:bg-blue-light-3 dark:hover:text-primary" href="#">
